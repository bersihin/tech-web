<template>
  <div>
    ...
    >
      <div class="lg:w-1/2">
        <h2
          class="font-bold text-3xl md:text-4xl leading-tight lg:leading-normal"
        >
        ...
        <p class="mt-8 lg:mt-12 font-normal text-grey">
          Besides building our business system, we are interested to share what
          we have done and learned to you. We feel flattered if you interested
          to join us.
        </p>
        <nuxt-link
